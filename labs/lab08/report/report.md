...
![Режим вставка](image/2.png){ #fig:001 width=70% }
...
![Режим последней строки](image/3.png){ #fig:001 width=70% }

5. Сделаем файл исполняемый (команд chmod) (рис.4).

![Изменение прав доступа](image/4.png){ #fig:001 width=70% }
...
![Удаление строки](image/6.png){ #fig:001 width=70% }

![Отмена последнего действия](image/7.png){ #fig:001 width=70% }

4. Введем символ : для перехода в режим послденей строки. Запишим произведенные ранее действия и выйдем из редактора vi. 

![Режим последней строки](image/8.png){ #fig:001 width=70% }
...
![Схема](image/11.png){ #fig:001 width=70% }
