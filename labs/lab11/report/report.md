...
![Командный файл](image/2.png){ #fig:001 width=70% }
...
![Права доступа](image/3.png){ #fig:001 width=70% }
...
![Командный файл](image/10.png){ #fig:001 width=70% }
